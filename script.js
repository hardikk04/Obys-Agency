...
if (
  ...
  Shery.imageEffect(".page4-elem-img", {
    style: 5,
    // debug: true,
    gooey: true,
    config: {
  ...
  Shery.imageEffect(".page5-elem-img", {
    style: 5,
    // debug: true,
    gooey: true,
    config: {
...
function page4Animation() {
  const page4Elem1Title = document.querySelector(".page4-elem-title");
  page4Elem1Title.addEventListener("mouseenter", () => {
    gsap.to(".page4-elem-title>h3", {
      y: -40,
    });
  });
  page4Elem1Title.addEventListener("mouseleave", () => {
    gsap.to(".page4-elem-title>h3", {
      y: 0,
    });
  });

  const page4Elem1Title2 = document.querySelector(".page4-elem-title2");
  page4Elem1Title2.addEventListener("mouseenter", () => {
    gsap.to(".page4-elem-title2>h3", {
      y: -40,
    });
  });
  page4Elem1Title2.addEventListener("mouseleave", () => {
    gsap.to(".page4-elem-title2>h3", {
      y: 0,
    });
  });

  const page4Circle = document.querySelector(".page4-circle");
  page4Circle.addEventListener("mouseenter", () => {
    tl.to(".circle-text1", {
      height: "100%",
      width: "100%",
    });
    tl.to(".circle-text1>span", {
      opacity: 1,
    });
  });

  page4Circle.addEventListener("mouseleave", () => {
    tl.to(".circle-text1>span", {
      opacity: 0,
    });
    tl.to(".circle-text1", {
...
function page5Animation() {
  const page5Elem1Title = document.querySelector(".page5-elem-title");
  page5Elem1Title.addEventListener("mouseenter", () => {
    gsap.to(".page5-elem-title>h3", {
      y: -40,
    });
  });
  page5Elem1Title.addEventListener("mouseleave", () => {
    gsap.to(".page5-elem-title>h3", {
      y: 0,
    });
  });

  const page5Elem1Title2 = document.querySelector(".page5-elem-title2");
  page5Elem1Title2.addEventListener("mouseenter", () => {
    gsap.to(".page5-elem-title2>h3", {
      y: -40,
    });
  });
  page5Elem1Title2.addEventListener("mouseleave", () => {
    gsap.to(".page5-elem-title2>h3", {
      y: 0,
    });
  });

  const page5Circle = document.querySelector(".page5-circle");
  page5Circle.addEventListener("mouseenter", () => {
    tl.to(".circle-text2", {
      height: "100%",
      width: "100%",
    });
    tl.to(".circle-text2>span", {
      opacity: 1,
    });
  });

  page5Circle.addEventListener("mouseleave", () => {
    tl.to(".circle-text2>span", {
      opacity: 0,
    });
    tl.to(".circle-text2", {
